...
function Sidebar({ view, onNavigate, onItemAction, inbox, notes, archive, tasks, people, ideas, plansCount }) {
    ...
    <aside style={sidebarStyles.root} data-screen-label="Sidebar">
      ...
      <div style={sidebarStyles.scroll}>
        ...
        <SidebarSection
          title="Ideas"
          addable
          items={(ideas || MEM_IDEAS).map((i) => ({
            id: i.id,
            label: i.title,
            active: view.type === "idea" && view.id === i.id,
          }))}
          onItemClick={(it) => onNavigate({ type: "idea", id: it.id })}
