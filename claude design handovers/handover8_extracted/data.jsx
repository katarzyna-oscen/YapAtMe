...
// Preset categories an idea can be filed under when promoted from the backlog.
// User can add new ones on the fly; these seed the chip row.
const IDEA_CATEGORIES = ["Ops", "AI", "Design", "Process", "Research"];

// IDEA_BACKLOG — the holding queue between inbox and a filed Idea.
// Flow: a note is captured → processed → if the AI detects an idea it tags the
// text with #idea and drops a one-line summary here. From the backlog the user
// tags a category and promotes it into a full Idea file (the idea-view template).
// Each item links back to the source note it was extracted from.
const IDEA_BACKLOG = [
  {
    id: "bk-ia-scaffold",
    summary: "Adopt a shared IA scaffold with local affordances as the cross-bubble navigation model.",
    sourceNoteId: "inbox-2026-05-22-1648",
  ...
  {
    id: "bk-someday-shelf",
    summary: "A “someday / maybe” shelf so parked ideas resurface on a schedule instead of rotting.",
    sourceNoteId: null,
  ...
  {
    id: "bk-voice-capture",
    summary: "Voice-first capture — hold a hotkey, dictate, and land it pre-routed in the inbox.",
    sourceNoteId: null,
  ...
  {
    id: "bk-autolink",
    summary: "Auto-link a new note to the project it mentions, without manual tagging.",
    sourceNoteId: null,
  ...
  {
    id: "bk-stale-nudge",
    summary: "Weekly “stale relationship” nudge that drafts a check-in message for people I’ve gone quiet on.",
    sourceNoteId: null,
...
Object.assign(window, {
  ...
  MEM_PEOPLE: PEOPLE,
  MEM_IDEAS: IDEAS,
  MEM_IDEA_CATEGORIES: IDEA_CATEGORIES,
  MEM_IDEA_BACKLOG: IDEA_BACKLOG,
  MEM_ACTIONS: ACTIONS,
