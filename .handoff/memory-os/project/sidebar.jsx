  ...
  return (
    <aside style={sidebarStyles.root} data-screen-label="Sidebar">
      ...
      <div style={sidebarStyles.scroll}>
        ...
        <SidebarSection title="Projects" items={MEM_PROJECTS.map((p) => p.id)} addable />
        <SidebarSection
          title="People"
          addable
        ...
        />
        <SidebarSection title="Ideas" items={["ai-memory-os", "daily-review", "project-health", "smart-inbox", "backlog"]} addable />
        <SidebarSection
          title="Archive"
