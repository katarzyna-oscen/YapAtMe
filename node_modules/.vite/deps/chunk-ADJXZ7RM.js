...
var ParserState = (_a5 = class extends Stack {
  constructor(schema2) {
    ...
    this.build = () => {
      let doc2;
      do
        doc2 = __privateGet(this, _closeNodeAndPush).call(this);
      while (this.size());
      return doc2;
    };
    this.next = (nodes = []) => {
...
var SerializerState = (_a7 = class extends Stack {
  constructor(schema2) {
    ...
    this.build = () => {
      let doc2 = null;
      do
        doc2 = __privateGet(this, _closeNodeAndPush2).call(this);
      while (this.size());
      return doc2;
    };
    this.next = (nodes) => {
...
var editorState = (ctx) => {
  ...
  return async () => {
    ...
    const doc2 = getDoc(ctx.get(defaultValueCtx), parser2, schema2);
...
var Editor = (_a10 = class {
  constructor() {
    ...
    __privateSet(this, _status2, EditorStatus.Idle);
...
//# sourceMappingURL=chunk-ADJXZ7RM.js.map
